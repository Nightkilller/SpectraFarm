...
def run_ground_truth_validation_pipeline() -> bool:
    ...
    # Step 3: Verified External Public Dataset Specification
    print("=" * 95)
    print("EXTERNAL PUBLIC BENCHMARK DATASET SPECIFICATION (AGRIFIELDNET INDIA)")
    print("=" * 95)
    print("  Dataset Name:                 AgriFieldNet Competition Dataset (DOI: 10.34911/rdnt.wu92p1)")
    print("  Curator / Authority:          Radiant Earth Foundation / IDinsight Data on Demand (ECAAS)")
    print("  License:                      Creative Commons Attribution 4.0 International (CC-BY-4.0)")
    print("  Geographic Coverage:          Northern India (Uttar Pradesh, Rajasthan, Odisha, Bihar)")
    print("  CRITICAL LIMITATION:          DOES NOT COVER SEHORE / MADHYA PRADESH")
    print("  Classification:               EXTERNAL_PUBLIC_DATASET (Must NOT be used as Sehore ground truth)")
    print("  Total Fields:                 7,081 fields (5,551 train, 1,530 test across 1,217 tiles)")
    print("  Crop Classes (13):            Wheat, Mustard, Lentil, Green pea, Sugarcane, Garlic, Maize,")
    print("                                Gram, Coriander, Potato, Berseem, Rice, Fallow")
    print("=" * 95)
    print()
    ...
    print("⚠️  DATA NOTICE: AgriN currently has 0 verified field-level crop labels for Sehore.")
    print("⚠️  DATA NOTICE: AgriFieldNet is an external public dataset for pipeline testing and does NOT validate Sehore satellite predictions.")
    print()
    print("=" * 95)
